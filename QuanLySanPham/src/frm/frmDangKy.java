...
public class frmDangKy extends javax.swing.JFrame {
    ...
    private void initComponents() {
                        ...
                        .addGroup(pnlRegisterInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlRegisterInfoLayout.createSequentialGroup()
                                .addGroup(pnlRegisterInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtRetypePasswword, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
        ...
        pnlRegisterInfoLayout.setVerticalGroup(
            ...
            .addGroup(pnlRegisterInfoLayout.createSequentialGroup()
                .addGap(14, 14, 14)
                .addComponent(txtMaNhanVien, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(4, 4, 4)
    ...
    private void btnĐangKyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnĐangKyActionPerformed
        ...
        if (MaNhanVien.equals("")) {
            ...
            if (TenDangNhap.length() < 6 || TenDangNhap.length() > 10) {
                ...
                ResultSet rs2 = process.ProcessMain.connection.ExcuteQueryGetTable(cautruyvan2);
                try {
                    rs2.next();
                ...
                if (kt == true) {
                    String ctv = "Insert into dbo.Users(MaNhanVien, TenDangNhap, Password, Quyen, ChuThich) values('"+ MaNhanVien +"', '"+ TenDangNhap +"', '"+ Password +"','"+ Quyen +"', N' ')";
                    //Sai truy vấn
                        /*"insert into Users values(" + MaNhanVien
                        + " ,'" + TenDangNhap + "' , '" + Password + "' ," + Quyen
                        + ", N' ')";*/
                    System.out.println(cautruyvan);
                    ProcessMain.connection.ExcuteQueryUpdateDB(ctv);
                    System.out.println("Đã Thêm Thành Công");
                    ThongBao("Tạo tài khoản thành công", "Thông Báo", 1);
//                    this.dispose();
...
//                    frmDN.show();
    ...
    private void btnDangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangNhapActionPerformed
        ...
        if (strUsername.equals("")) {
            ...
            process.ProcessMain.frmTC.show();
            this.dispose();
        } else {
