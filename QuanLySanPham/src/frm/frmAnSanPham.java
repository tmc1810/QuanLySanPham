...
public class frmAnSanPham extends javax.swing.JFrame {
    ...
    private void btnAnSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnSanPhamActionPerformed
        ...
        MaSanPham = process.ProcessMain.frmTC.GetMaSanPham();
        ...
        if (kiemtra) {
            ...
            process.ProcessMain.frmTC.ThongBao("Không thể ", "Sửa Sản Phẩm", 2);
        }
        process.ProcessMain.frmTC.LayDuLieuSanPham("1");
        this.dispose();
    }//GEN-LAST:event_btnAnSanPhamActionPerformed

    private void btnXoaSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaSanPhamActionPerformed

        if (!process.ProcessMain.frmTC.GetMaSanPham().equals("")) {
            process.ProcessMain.frmTC.XoaSanPham();
            process.ProcessMain.frmTC.ResSanPham();
            this.dispose();
        } else {
            process.ProcessMain.frmTC.ThongBao("bạn chưa nhập mã sản phẩm", "lỗi khi xóa", 2);
        }
